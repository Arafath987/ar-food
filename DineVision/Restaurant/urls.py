...
urlpatterns = [
    ...
    path('get-menu-items/<int:restaurant_id>', MenuItemViewSet.get_menu_items, name='get-menu-items'),
    path('get-categories/<int:restaurant_id>', CategoryViewSet.user_viewcategory, name='user_viewcategory'),
    path('menuitems-by_category/<int:category_id>', MenuItemViewSet.as_view({'get': 'by_category'}), name='menuitem-by-category'),
    path('menuitems/detail/<int:menu_item_id>', MenuItemViewSet.as_view({'get': 'item_detail'}), name='menuitem-detail'),
    path('admin_menuitems/<int:menu_item_id>/detail', MenuItemViewSet.as_view({'get': 'admin_item_detail'}), name='menuitem-detail'),
    path('menuitems/create', MenuItemViewSet.as_view({'post': 'create_menuitem'}), name='menuitem-create'),
