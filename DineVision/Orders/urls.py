...
urlpatterns = [
    ...
    path('orders/proceed-to-preparation/<int:order_id>', OrderViewSet.as_view({'post': 'proceed_to_preparation'}), name='proceed-to-preparation'),
    path('orders/preparation-orders', OrderViewSet.as_view({'get': 'preparation_orders'}), name='preparation-orders'),
    path('orders/proceed-to-delivery/<int:order_id>', OrderViewSet.as_view({'post': 'proceed_to_delivery'}), name='proceed-to-delivery'),
