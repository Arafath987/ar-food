   ...
   */ const generateStaticHTML = supportsDynamicHTML !== true;
     ...
     */ const createServerComponentsRenderer = (loaderTreeToRender, preinitScripts)=>createServerComponentRenderer(async (props)=>{
        ...
        const bodyResult = getTracer().wrap(AppRenderSpan.getBodyResult, {
            ...
            const [preinitScripts, bootstrapScript] = getRequiredScripts(buildManifest, assetPrefix, subresourceIntegrityManifest, getAssetQueryString(true), nonce);
            ...
            try {
                ...
                const [errorPreinitScripts, errorBootstrapScript] = getRequiredScripts(buildManifest, assetPrefix, subresourceIntegrityManifest, getAssetQueryString(false), nonce);
