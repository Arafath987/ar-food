...
export function onDemandEntryHandler({ hotReloader, maxInactiveAge, multiCompiler, nextConfig, pagesBufferLength, pagesDir, rootDir, appDir }) {
        ...
        try {
            ...
            runDependingOnPageType({
                ...
                onServer: ()=>{
                    ...
                    const edgeServerEntry = getEntryKey(COMPILER_NAMES.edgeServer, pageBundleType, definition.page);
                    if (curEntries[edgeServerEntry] && !isInstrumentationHookFile(definition.page)) {
                ...
                onEdgeServer: ()=>{
                    ...
                    const serverEntry = getEntryKey(COMPILER_NAMES.server, pageBundleType, definition.page);
                    if (curEntries[serverEntry] && !isInstrumentationHookFile(definition.page)) {
            ...
            if (hasNewEntry) {
                reportTrigger(!clientOnly && hasNewEntry ? `${definition.page}` : definition.page);
            }
    ...
    return {
        async ensurePage ({ page, clientOnly, appPaths = null, match, isApp }) {
            ...
            if (!appPaths && (match == null ? void 0 : match.definition) && isAppPageRouteDefinition(match.definition)) {
