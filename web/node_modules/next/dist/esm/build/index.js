        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
                ...
                return new Worker(staticWorkerPath, {
                    ...
                    forkOptions: {
                        env: {
                            ...
                            __NEXT_PRIVATE_PREBUNDLED_REACT: needsExperimentalReact(config) ? "experimental" : "next"
                        }
                    },
            ...
            if (!isGenerate && config.outputFileTracing) {
                ...
                await nextBuildSpan.traceChild("trace-next-server").traceAsyncFn(async ()=>{
                    ...
                    const minimalCachedTracePath = path.join(distDir, "cache/next-minimal-server.js.nft.json");
                    ...
                    !config.experimental.incrementalCacheHandlerPath) {
                        ...
                        try {
                            ...
                            const existingMinimalTrace = JSON.parse(await fs.readFile(minimalCachedTracePath, "utf8"));
                            if (existingTrace.cacheKey === cacheKey && existingMinimalTrace.cacheKey === cacheKey) {
                                ...
                                await fs.copyFile(minimalCachedTracePath, nextMinimalTraceOutput);
                                return;
                            }
                        } catch  {}
                    }
                    ...
                    await fs.copyFile(nextMinimalTraceOutput, minimalCachedTracePath).catch(()=>{});
                });
            }
